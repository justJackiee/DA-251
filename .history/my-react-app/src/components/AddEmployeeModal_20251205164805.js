      ...
      <div className="bg-gray-50 rounded-lg p-4">
        ...
        <div>
          ...
          <div
            ...
            onKeyPress={(e) => { if (e.key === 'Enter' || e.key === ' ') fileInputRef.current && fileInputRef.current.click(); }}
            ...
            <div className="flex flex-col items-center">
              ...
              {formData.contractFile ? (
                <div className="text-sm text-gray-700">
                  ...
                  <button
                    type="button"
                    onClick={(ev) => { ev.stopPropagation(); handleInputChange('contractFile', ''); if (fileInputRef.current) fileInputRef.current.value = ''; }}
