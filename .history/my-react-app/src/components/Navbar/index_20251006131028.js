...
export function HRNavbar() {
  ...
  return (
    <nav style={{
      ...
      position: 'relative',
      minHeight: '80px',  // Fixed navbar height
      maxHeight: '80px'   // Prevent navbar from growing
    }}>
      {/* Main Navigation Bar */}
      <div style={{
        display: 'flex',
        ...
        <div style={{
          ...
          height: '100%'      // Maintain consistent height
            ...
            <div style={{
              display: 'flex',
              alignItems: 'center',
              height: '60px',     // Fixed container height for logo
              width: '60px',      // Fixed container width for logo
