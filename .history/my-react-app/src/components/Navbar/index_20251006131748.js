  ...
  return (
    <nav style={{
      ...
      <div style={{
        ...
        alignItems: 'center',
        height: '70px',           // Match navbar height exactly
        padding: '0 2rem',        // Move padding here
        ...
        <div style={{
          ...
          alignItems: 'center',
          gap: '3rem',
          height: '70px'            // Match parent height
        }}>
            {/* Brand / Logo */}
            <div style={{
              height: '30px',           // Fixed logo container height
              width: '50px',            // Fixed logo container width  
              display: 'flex',
              alignItems: 'center',
              ...
              <img 
                ...
                style={{ 
                  maxHeight: '80px',      // Cannot exceed container height
                  maxWidth: '80px',       // Cannot exceed container width
