  ...
  return (
    <div>
      ...
      <div className="flex justify-end">
        {/* pass onAdd so FiltersBar can trigger navigation when Add button clicked */}
      </div>
      <FiltersBar search={search} onSearch={setSearch} filters={filters} onFilterChange={onFilterChange} onClear={onClear} onAdd={() => navigate('/employees/new')} />
