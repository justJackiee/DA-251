...
function EmployeeManagement() {
  ...
  return (
    <div>
      ...
      <FiltersBar sear
      ch={search} onSearch={setSearch} filters={filters} onFilterChange={onFilterChange} onClear={onClear} positions={positions} genders={genders} types={types} statuses={statuses} />
