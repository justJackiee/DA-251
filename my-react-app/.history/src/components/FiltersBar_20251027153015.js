...
export default function FiltersBar({ search, onSearch, filters, onFilterChange, onClear }) {
  ...
  <div className="bg-white p-4 rounded-md shadow-sm flex flex-col md:flex-row md:items-center gap-3 overflow-visible">
        ...
        <div className="flex w-full md:w-auto gap-3 items-center">
          <select
            ...
            className="border rounded px-3 py-2 text-sm w-full md:w-70 min-w-0"
            style={{ direction: 'ltr' }}
          >
