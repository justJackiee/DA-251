        ...
        <div className="mt-3 md:mt-4">
          ...
          <div className="hidden md:grid md:grid-cols-3 md:items-center">
            ...
            <div className="flex justify-center">
              <nav className="flex justify-center w-full space-x-6 text-sm text-gray-500">
                <button
          ...
          <div className="md:hidden">
            <nav className="flex justify-center w-full space-x-6 text-sm text-gray-500 overflow-x-auto">
              <button
                className={`px-3 py-2 ${active === 'team' ? 'text-indigo-600 font-medium border-b-4 border-indigo-600' : 'hover:text-indigo-600'}`}
                onClick={() => onTabChange?.('team')}
                aria-current={active === 'team' ? 'page' : undefined}
